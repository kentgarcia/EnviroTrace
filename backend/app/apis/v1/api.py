...
from . import auth_router, profile_router, emission_router, fee_router, test_schedules, tree_management_router, planting_router, admin_router, session_router, air_quality_router
...
api_v1_router.include_router(air_quality_router.router, prefix="/air-quality", tags=["Air Quality"])
