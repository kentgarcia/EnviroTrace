...
def _serialize_project(project) -> dict:
    ...
    data = {
        ...
        "date_received": project.date_received_of_request.isoformat() if project.date_received_of_request else None,
        "date_sapling_received": project.date_sapling_received.isoformat() if project.date_sapling_received else None,
