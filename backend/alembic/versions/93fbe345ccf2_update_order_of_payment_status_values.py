"""update_order_of_payment_status_values

Revision ID: 93fbe345ccf2
Revises: 55324ef4d234
Create Date: 2025-08-29 02:30:06.736555
...
def upgrade() -> None:
    ...
    op.alter_column('order_of_payments', 'selected_violations',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=False,
               schema='air_quality')
    op.alter_column('order_of_payments', 'test_results',
               existing_type=sa.TEXT(),
               type_=sa.String(),
    ...
    op.add_column('sapling_requests', sa.Column('monitoring_request_id', sa.String(), nullable=True), schema='urban_greening')
