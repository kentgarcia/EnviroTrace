"""Remove monitoring_request_id from sapling_requests

Revision ID: f1dcc0ddbb75
Revises: 34e55b12cc90
Create Date: 2025-08-23 22:16:44.146547
...
revision: str = 'f1dcc0ddbb75'
down_revision: Union[str, None] = '34e55b12cc90'
...
def downgrade() -> None:
    ...
    op.alter_column('urban_greening_plantings', 'location',
               ...
               nullable=True,
               schema='urban_greening')
    op.add_column('sapling_requests', sa.Column('monitoring_request_id', sa.VARCHAR(), autoincrement=False, nullable=True), schema='urban_greening')
