...
import { Loader2, User, Mail, ShieldCheck, Save, Briefcase, Phone } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { Separator } from "@/components/ui/separator";
import { Textarea } from "@/components/ui/textarea";
import { fetchMyProfile, updateProfile } from "@/lib/profile-api";
              ...
              <CardContent className="flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  ...
                  {profileData.jobTitle && (
                    <p className="text-sm text-muted-foreground mt-1">{profileData.jobTitle}</p>
                  )}
                </div>
