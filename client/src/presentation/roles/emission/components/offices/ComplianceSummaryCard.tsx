...
import { OfficeData } from "@/core/api/emission-service";
  ...
  const cards = [
    {
      ...
      difference:
        complianceDiff !== 0 ? (
          <div
            className={`flex items-center text-xs ${isImproving ? "text-green-500" : "text-red-500"
              }`}
          >
            {isImproving ? (
