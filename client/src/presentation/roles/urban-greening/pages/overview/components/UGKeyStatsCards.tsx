...
export const UGKeyStatsCards: React.FC<UGKeyStatsCardsProps> = ({ feeData }) => {
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-4">
            <StatCard label={`Fees Collected (${currentYear})`} value={feesThisYear} Icon={Banknote} loading={false} />
            <StatCard label={`Fees Collected (${currentMonthName})`} value={feesThisMonth} Icon={CreditCard} loading={false} />
