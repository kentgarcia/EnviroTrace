...
} from "../../planting-records/logic/usePlantingRecords";

export const SAPLING_MGMT_KEYS = {
  saplingRequests: ["sapling-requests"] as const,
};

export const useSaplingRequests = () => {
  const { data = [], refetch } = useQuery({
    queryKey: SAPLING_MGMT_KEYS.saplingRequests,
...
export const useSaplingRequestMutations = () => {
  ...
  const invalidate = () =>
    qc.invalidateQueries({ queryKey: SAPLING_MGMT_KEYS.saplingRequests });
