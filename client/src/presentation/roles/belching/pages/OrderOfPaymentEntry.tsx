  ...
  return (
    <div className="max-w-4xl mx-auto py-8 space-y-8">
      ...
      <div className="bg-white rounded shadow p-4 mb-4">
        <h2 className="text-lg font-bold mb-2 text-blue-900">Select Record</h2>
        <input
          type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, voluntaryFee: Number(e.target.value) }))
              }
              min={0}
              className="border rounded px-2 py-1 w-full"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, impoundFee: Number(e.target.value) }))
              }
              min={0}
              className="border rounded px-2 py-1 w-full"
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm((f) => ({ ...f, driverAmount: Number(e.target.value) }))
              }
              min={0}
              className="border rounded px-2 py-1 w-full"
            />
