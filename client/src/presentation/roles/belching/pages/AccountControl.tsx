...
import AccountControlComponent from "../components/AccountControl";
  ...
  const handleRefresh = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "The account control data has been refreshed.",
      });
    }, 1000);
  };
          ...
          <div className="flex items-center justify-between bg-white px-6 py-4 border-b border-gray-200">
            <div>
              ...
              <p className="text-muted-foreground">
                Manage and monitor account information and status
              </p>
            </div>
