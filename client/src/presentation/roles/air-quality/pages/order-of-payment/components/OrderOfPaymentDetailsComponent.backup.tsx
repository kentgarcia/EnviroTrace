    ...
    const handleSaveOrder = () => {
        ...
        if (newOrderData && (!selectedOrder || !selectedOrder.id)) {
            ...
            const newOrderPayload = {
                ...
                or_number: paymentInfo.or_number,
                payment_date: paymentInfo.payment_date,
                total_amount: paymentInfo.total_amount,
                discount: paymentInfo.discount,
                grand_total_amount: paymentInfo.total_amount - paymentInfo.discount,
                date_of_payment: paymentInfo.payment_date,
            };
                                    ...
                                    {violations.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={5} className="text-center text-muted-foreground py-8">
                                                No violations available for payment breakdown.
                                            </TableCell>
                                        </TableRow>
                                    ) : (
                                        <>
                                            ...
                                            {violations.map((violation) => {
                                                ...
                                                return (
                                                    <TableRow key={`driver-${violation.id}`}>
                                                        <TableCell>Driver Offense</TableCell>
                                            ...
                                            {violations.map((violation) => {
                                                ...
                                                return (
                                                    <TableRow key={`operator-${violation.id}`}>
                                                        <TableCell>Operator Offense</TableCell>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell>
                                                    {testingInfo.date_of_testing || 'TBD'}
                                                </TableCell>
                                                <TableCell>
                ...
                <Card className="flex flex-col">
                    ...
                    <CardContent className="flex-1 space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                id="paymentOrNumber"
                                value={paymentInfo.or_number || ''}
                                onChange={(e) => setPaymentInfo(prev => ({ ...prev, or_number: e.target.value }))}
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => setPaymentInfo(prev => ({ ...prev, total_amount: parseFloat(e.target.value) || 0 }))}
                                placeholder="0.00"
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => setPaymentInfo(prev => ({ ...prev, discount: parseFloat(e.target.value) || 0 }))}
                                placeholder="0.00"
                            />
                        </div>
                        ...
                        {/* Grand Total Amount */}
                        <div className="space-y-2">
                            <Label className="text-lg font-semibold">Grand Total Amount</Label>
                            <div className="text-2xl font-bold text-green-600">
                                ₱{(paymentInfo.total_amount - paymentInfo.discount).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                            </div>
                        </div>
